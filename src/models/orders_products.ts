...
export class orders_products{
    ...
    async add_product(order_id:string, product_id:string, quantity:string):Promise<order>{

        try{
            const sql:string = `INSERT INTO orders_products (order_id, product_id, quantity) VALUES ($1, $2, $3) RETURNING *`
