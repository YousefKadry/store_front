...
var add_product = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, added_prodcut.add_product(req.body.order_id, req.body.product_id, req.body.quantity)];
            case 1:
                results = _a.sent();
                res.json(results);
                return [3 /*break*/, 3];
...
var destroy = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, added_prodcut.delete(req.body.order_id, req.body.product_id)];
            case 1:
                deleted = _a.sent();
                res.json(deleted);
                return [2 /*return*/];
