...
var users = /** @class */ (function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        err_1 = _a.sent();
                        throw new Error("Could not get the users. Error: ".concat(err_1));
    ...
    users.prototype.create = function (user) {
        return __awaiter(this, void 0, void 0, function () {
            var sql, connect, hash, result, err_3;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        hashed = _a.sent();
                        connect.release();
                        _password = password + pepper;
                        if (hashed.rows.length) {
                            result = hashed.rows[0];
                            if (bcrypt_1.default.compareSync(_password, result.password)) {
